...
st.set_page_config(
    page_title="BCA V Semester Result Analysis",
    page_icon="🎓",
    layout="wide",
...
<title>BCA V Result Analysis Report</title>
<style>
...
<body>
<div class="ph">
  <h1>BCA V SEMESTER RESULT ANALYSIS</h1>
...
<div class="ft">
  Generated by BCA V Result Analysis System &nbsp;|&nbsp;
...
<div class="main-header">
  <h1>🎓 BCA V Semester – Result Analysis System</h1>
...
with st.sidebar:
    ...
    uploaded = st.file_uploader(
        "BCA V Result Format (.xlsx)", type=['xlsx'],
        help="BCA_V_RESULT_FORMAT.xlsx — Sheet 1: student data | Sheet 2: subject-faculty map"
    )
    st.markdown("---")
    st.markdown("""
### 📌 Instructions
...
if not uploaded:
    ...
    <div style="border:2px dashed #3949ab;border-radius:12px;padding:2.5rem;
      ...
      <h3 style="color:#1a237e">📤 Upload BCA V Result Format Excel</h3>
